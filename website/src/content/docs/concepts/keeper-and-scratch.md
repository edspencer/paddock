---
title: "Keeper vs. scratch agents"
description: "One keeper agent per project, a shared scratch agent for one-off chats, and promotion."
---
...
[sweeper](/concepts/sweeper), which is an internal per-project agent you never chat
with directly.
...
- Is the only agent that can receive the [self-management MCP](/architecture/overview#5-mcp-injection)
...
- Don't trigger a [sweep](/concepts/sweeper) (there's no project to curate).
