...
- [#924](https://github.com/edspencer/paddock/pull/924) [`05acfa8`](https://github.com/edspencer/paddock/commit/05acfa861ea7828149825c57260e8310c6c0f601) Thanks [@edspencer](https://github.com/edspencer)! - Discover is now reachable from the Projects header in the side nav, as a
  magnifying-glass button beside the `+`. It previously lived only in the footer
  utility stack between Config and the theme toggle — 671px away and grouped with
  instance chrome, where an early user could not find it, even though what it does
  (bring projects into the list) is the same job as the `+`. The footer link stays;
  there are simply two doors onto the same `/discover` route now.

- [#926](https://github.com/edspencer/paddock/pull/926) [`07e2050`](https://github.com/edspencer/paddock/commit/07e2050bd8a605d13b155b3d1a21010c66e681d4) Thanks [@edspencer](https://github.com/edspencer)! - Add a Delete Project flow to the project Settings tab, and fix the delete
  ...
  metadata directory, so the user's own clone is untouched — deleting _unlinks_.
...
- [#910](https://github.com/edspencer/paddock/pull/910) [`e55e884`](https://github.com/edspencer/paddock/commit/e55e884291368dbc96ad1747a4b84f9ab9a2c7c9) Thanks [@edspencer](https://github.com/edspencer)! - Bound the composer's attachment tray so the message box stays reachable (#909).
...
- [#888](https://github.com/edspencer/paddock/pull/888) [`e045477`](https://github.com/edspencer/paddock/commit/e0454775b15181bcc0cec0defd4457e01445b7a7) Thanks [@edspencer](https://github.com/edspencer)! - Forking from a message now asks for a name first, like every other fork does.
  ...
  asymmetry was backwards: forking from a _specific_ message is the more deliberate
  ...
  The dialog also opens showing the _start_ of that pre-filled name. `select()`
...
- [#875](https://github.com/edspencer/paddock/pull/875) [`80f489f`](https://github.com/edspencer/paddock/commit/80f489fa993a388e077c94594654abe53cd162ef) Thanks [@edspencer](https://github.com/edspencer)! - A chat's "updated X ago" — and the order the chat list is in — now comes from
...
- [#870](https://github.com/edspencer/paddock/pull/870) [`f87225a`](https://github.com/edspencer/paddock/commit/f87225ac8d24f6e561a16b2e967bba2ad546bd4f) Thanks [@edspencer](https://github.com/edspencer)! - **The root workspace's Home is now the instance's onboarding surface** (#865).
...
- [#843](https://github.com/edspencer/paddock/pull/843) [`7f26064`](https://github.com/edspencer/paddock/commit/7f26064f51afcd031980bf5520869fb18b918ef4) Thanks [@edspencer](https://github.com/edspencer)! - Dock the running-work bar below the "working…" indicator, so it sits nearest the composer.

## 0.70.0

### Patch Changes

- [#835](https://github.com/edspencer/paddock/pull/835) [`493d9e5`](https://github.com/edspencer/paddock/commit/493d9e55727dabef4a8e001534308ef44f9d1913) Thanks [@edspencer](https://github.com/edspencer)! - Restore the inline-code highlight and the blockquote colour in rendered markdown
...
- [#805](https://github.com/edspencer/paddock/pull/805) [`2685416`](https://github.com/edspencer/paddock/commit/2685416c3acf73232e237c9c104567123310e6ca) Thanks [@edspencer](https://github.com/edspencer)! - Remove the `recovery.limboTimeoutMs` lever, which never did anything
  ...
  The docs were honest about it (_"Backstop timer ships in a follow-up"_), but the
  ...
  **Nothing breaks for existing installs.** `sanitizeRecoveryOverride` is an
  ...
  "remove a _load-bearing_ key", and this one carried no load, which is the point.
...
- [#812](https://github.com/edspencer/paddock/pull/812) [`82d9241`](https://github.com/edspencer/paddock/commit/82d9241d913493ebbd121cf9b091476b5d6f2b6c) Thanks [@edspencer](https://github.com/edspencer)! - Two small fixes to what the UI shows you (#546, #775)

  - **The root workspace's Settings tab no longer shows a blank SLUG (#546).** The
    root workspace's key _is_ the empty string — a real, routable key, not an
  ...
  - **`PADDOCK_SELF_MCP_PROJECTS` now describes what it actually grants (#775).**
    ...
    deserved a separate flag _because_ of that clone; the help text was the one
...
- [#807](https://github.com/edspencer/paddock/pull/807) [`b1a294d`](https://github.com/edspencer/paddock/commit/b1a294dccc448c1166dba07977f24736e81fef88) Thanks [@edspencer](https://github.com/edspencer)! - Show background work that is still running, pinned above the composer (#604)
...
- [#759](https://github.com/edspencer/paddock/pull/759) [`5b31877`](https://github.com/edspencer/paddock/commit/5b31877c28db7c1fb33fa8b95e2f848982fe4aeb) Thanks [@edspencer](https://github.com/edspencer)! - Keep polling a still-running sub-agent after navigating away and back (#725 cause B).
...
- [#740](https://github.com/edspencer/paddock/pull/740) [`16d9c32`](https://github.com/edspencer/paddock/commit/16d9c324627c90da807bde6f2f6a7d3d140ddde1) Thanks [@edspencer](https://github.com/edspencer)! - The instance **Config** screen is navigable instead of one long slab. It rendered
...
- [#748](https://github.com/edspencer/paddock/pull/748) [`a4b6390`](https://github.com/edspencer/paddock/commit/a4b6390b9b94819903999336721330b568a3fb8f) Thanks [@edspencer](https://github.com/edspencer)! - The UI now says **adopt** instead of **import** for bringing in your terminal
  `claude` history (#744).
  ...
  are _already_ inside the project's transcript store — the action registers them
  ...
  the action copies _and_ adopts, and adopt is the user-meaningful half.
