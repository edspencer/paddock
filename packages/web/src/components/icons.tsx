// Tiny inline SVG icon set (no icon dependency). Stroke-based, currentColor.
...
export const PinIcon = (p: IconProps) => (
  <svg {...base(p)}>
    <path d="M12 17v5" />
    <path d="M9 10.76V4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v6.76a2 2 0 0 0 .59 1.42l1.12 1.12A1 1 0 0 1 17 15H7a1 1 0 0 1-.71-1.7l1.12-1.12A2 2 0 0 0 9 10.76Z" />
  </svg>
);
...
export const EnvelopeIcon = ({ open, ...p }: IconProps & { open?: boolean }) =>
  open ? (
    <svg {...base(p)}>
...
// An archive box: a lid across the top, a body below, and a pull-slot handle.
