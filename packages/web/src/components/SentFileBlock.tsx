...
function ImageBody({
  ...
  src?: string;
  filename: string;
  /** The agent's optional caption — surfaced beneath the lightbox image. */
  message?: string;
}) {
 ...
 * reveals it. All actions key off `src` (the attachment's `rawUrl`).
 */
 ...
 * agent's caption, if any — sit beneath the image, legible on the dim backdrop.
 */
