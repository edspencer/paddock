 ...
 * page — fine for "this project failed to load", useless for "imported 7 chats".
 */
describe("Toast", () => {
  ...
  it("announces the message politely rather than as an interruption", () => {
    render(<Toast message="Imported 7 chats" onDismiss={() => {}} />);
    const live = screen.getByRole("status");
    expect(live).toHaveTextContent("Imported 7 chats");
  ...
  it("dismisses on the close button", () => {
    ...
    render(<Toast message="Imported 7 chats" onDismiss={onDismiss} />);
  ...
  it("dismisses itself once the dwell elapses", () => {
    vi.useFakeTimers();
    const onDismiss = vi.fn();
    render(<Toast message="Imported 7 chats" onDismiss={onDismiss} durationMs={5000} />);
