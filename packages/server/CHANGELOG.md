...
- [#934](https://github.com/edspencer/paddock/pull/934) [`4be758e`](https://github.com/edspencer/paddock/commit/4be758e17f3613a478e4e5694360cd7ecbb649e3) Thanks [@edspencer](https://github.com/edspencer)! - Bump `@anthropic-ai/claude-agent-sdk` from 0.3.216 to 0.3.283, which raises the bundled `claude` binary from 2.1.216 to 2.1.283.
...
- [#876](https://github.com/edspencer/paddock/pull/876) [`cf15276`](https://github.com/edspencer/paddock/commit/cf152765b0fa64d573df411d08e7f269bd8bd499) Thanks [@edspencer](https://github.com/edspencer)! - `paddock service install` no longer sits silent for several seconds and then
