...
> Read **[Testing](https://paddock.edspencer.net/contributing/testing/)** instead
> (source: [`website/src/content/docs/contributing/testing.md`](https://github.com/edspencer/paddock/blob/main/website/src/content/docs/contributing/testing.md)).
>
